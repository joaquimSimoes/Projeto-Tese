...
@Composable
fun MudarEmailFP(navController: NavController){
            ...
            Button(
                onClick = {
                    ...
                    coroutineScope.launch {
                        ...
                        if (user != null && user.hasFingerprint) {
                            ...
                            prompt.authenticate(
                                buildPromptInfo(
                                    ...
                                    subtitle = "Use a impressão digital para entrar"
                                )
                            )
                        } else {
                            showErrors = true
                ...
                Text("Proceder para a leitura de impressão digital", color = Color.Black)
            }
        }
    ) { innerPadding ->
